...
kable(pred,caption = "Predicción de acierto en la pregunta 101") %>% 
  kable_styling(full_width = F,position = "center") %>% 
  kable_minimal()
```
